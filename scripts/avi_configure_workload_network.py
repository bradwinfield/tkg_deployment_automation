...
# If the Primary workload network and the data network are the same network, then this
# step is not needed.
if primary_workload_network_ip == data_network_ip:
    pmsg.green("Primary and Data networks are the same. This is not needed. Workload network OK.")
    exit(0)
